                        ...
                        >
                            <div className="flex items-center gap-6 mb-10">
                                ...
                                <div>
                                    ...
                                    <p className="text-slate-500 font-bold">Verified Member since {contractor.verifiedSince}</p>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-8">
                                <div className="bg-white dark:bg-slate-700 p-6 rounded-2xl text-center shadow-sm">
                                    ...
                                    <p className="text-sm font-black text-slate-500 uppercase tracking-widest">Projects Done</p>
                                </div>
                                <div className="bg-white dark:bg-slate-700 p-6 rounded-2xl text-center shadow-sm">
                                    <p className="text-4xl font-black text-secondary mb-1">{contractor.rating}</p>
                                    <p className="text-sm font-black text-slate-500 uppercase tracking-widest">Worker Rating</p>
                                </div>
                            </div>
                            ...
                            <div className="mt-8 p-6 bg-green-50 dark:bg-green-900/20 rounded-2xl flex items-center justify-between border border-green-100 dark:border-green-800/50">
                                <span className="text-lg font-bold text-slate-700 dark:text-slate-200">Payment Reliability</span>
